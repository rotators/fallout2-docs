...
- [Fallout 2 CE `scripts.cc`](https://github.com/fallout2-ce/fallout2-ce/blob/main/src/scripts.cc) - runtime loading of `scripts.lst`, local variable counts, script IDs, procedure lookup, and MSG lookup behavior.
- [Fallout 2 CE `interpreter.cc`](https://github.com/fallout2-ce/fallout2-ce/blob/main/src/interpreter.cc) and [`interpreter_extra.cc`](https://github.com/fallout2-ce/fallout2-ce/blob/main/src/interpreter_extra.cc) - runtime interpreter behavior and built-in game opcode handlers that SSL compiles to.
